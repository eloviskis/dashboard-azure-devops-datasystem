  ...
  return (
    <ResponsiveContainer width="100%" height={350}>
      <BarChart data={chartData} layout="vertical" margin={{ top: 5, right: 70, left: 20, bottom: 5 }}>
        ...
        />
        <Bar dataKey="value" name="Itens Concluídos" fill={groupBy === 'assignedTo' ? CHART_COLORS.primary : CHART_COLORS.secondary} label={{ position: 'right', fill: groupBy === 'assignedTo' ? CHART_COLORS.primary : CHART_COLORS.secondary, fontSize: 11, fontWeight: 'bold' }} />
      </BarChart>
    </ResponsiveContainer>
  );
};
