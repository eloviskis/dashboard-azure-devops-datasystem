    ...
    <>
      ...
      <ResponsiveContainer width="100%" height={350}>
        <BarChart data={chartData} layout="vertical" margin={{ top: 5, right: 70, left: 20, bottom: 5 }}>
          ...
          />
          <Bar dataKey="value" name="Ocorrências" fill={CHART_COLORS.primary} cursor="pointer" label={{ position: 'right', fill: CHART_COLORS.primary, fontSize: 11, fontWeight: 'bold' }}>
